...
const SidebarContent = props => {
  ...
  <ul className="sub-menu">
    <li className="dropdown-submenu">
      {/* <Link to="/dashboard">{props.t("Third Floor")} 3</Link> */}
      {/* <ul className="sub-menu">
        <li><Link to="/dashboard">{props.t("TECHINICALHUB_3F_H1")}</Link></li>
        <li><Link to="/dashboard">{props.t("TECHINICALHUB_3F_H1")}</Link></li>
      </ul> */}
    </li>
    <li className="dropdown-submenu">
      <Link to="/dashboard2">{props.t("FOURTH FLOOR")} 4</Link>
      <ul className="sub-menu">
        <li><Link to="/dashboard2">{props.t("TECHINICALHUB_4F_H1")}</Link></li>
        <li><Link to="/dashboard2">{props.t("TECHINICALHUB_4F_H2")}</Link></li>
      </ul>
    </li>
  </ul>
</li>
            ...
            <li>
              <Link to="/#" className="has-arrow waves-effect">
                ...
                <span>{props.t("MAC ADDRESSESS")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
                  <Link to="/email-inbox">{props.t("CLIENT MAC")}</Link>
                </li>
                <li>
                  <Link to="/email-read">{props.t("MAC")} </Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li><Link to="/tasks-list">{props.t("DEVICES")}</Link></li>
                <li><Link to="/tasks-kanban">{props.t("CLIENTS")}</Link></li>
                {/* <li><Link to="/card-tasks">{props.t("MAC")}</Link></li> */}
                <li><Link to="/tasks-create">{props.t("STATISTICS")}</Link></li>
              </ul>
            </li>
            <li>
              <Link to="/#" className="has-arrow waves-effect">
            ...
            <li>
              <Link to="/#" className="has-arrow waves-effect">
                ...
                <span>{props.t("Networking")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
                  <Link to="/ui-alerts">{props.t("Alarms")}</Link>
                </li> */}
                {/* <li>
            ...
            <li>
              <Link to="/#" className="has-arrow waves-effect">
                ...
                <span>{props.t("NET WORKING")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
                  <Link to="/tables-basic">{props.t("ACCESS")}</Link>
                </li>
                <li>
                  <Link to="/tables-datatable">{props.t("ALARAMS-HISTORY")}</Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/tables-editable">{props.t("CLIENTS SUMMARY")}</Link>
                </li>
              </ul>
            </li>
