            ...
            <div className="page-title-box d-flex align-items-center justify-content-between">
              ...
              <div className="page-title-right">
                <ol className="breadcrumb m-0">
                  <li className="breadcrumb-item active">Welcome to Thub Networking Dashboard</li>
                </ol>
              </div>
              ...
              <CardBody>
                <div className="d-flex align-items-start">
                  ...
                  <div className="flex-1">
                    <div className="font-size-16 mt-2">Total Devices</div>
                  </div>
                </div>
                <h4 className="mt-4">6</h4>
                <div className="row">
                  <div className="col-7">
                    <p className="mb-0"><span className="text-success me-2"> 100% <i
